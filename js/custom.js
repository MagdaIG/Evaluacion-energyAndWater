...
document.getElementById('dia-noche-btn').addEventListener('click', function() {
  document.body.classList.toggle('dark-layout');
  var icon = this.querySelector('i');
  const preguntas = document.getElementsByClassName('accordion-button');
  const respuestas = document.getElementsByClassName('accordion-body');

  if (icon.classList.contains('fa-moon')) {
    // Cambiar a modo oscuro
    for(let i = 0; i < preguntas.length; i++) {
      preguntas[i].classList.add('text-white');
      preguntas[i].classList.add('bg-dark');
    }
    for(let i = 0; i < respuestas.length; i++) {
      respuestas[i].classList.add('bg-dark');
      respuestas[i].classList.add('text-white');
    }
    ...
    for(let i = 0; i < preguntas.length; i++) {
      preguntas[i].classList.remove('text-white');
      preguntas[i].classList.remove('bg-dark');
    }
    for(let i = 0; i < respuestas.length; i++) {
      respuestas[i].classList.remove('bg-dark');
      respuestas[i].classList.remove('text-white');
    }
...
document.getElementById('ver-mas').addEventListener('click', function(event) {
  ...
  if (parrafo2.style.display === 'none') {
    parrafo2.style.display = 'block'; // Mostrar el segundo párrafo
    this.textContent = 'ver menos'; // Cambiar el texto del enlace a "ver menos"
  } else {
    parrafo2.style.display = 'none'; // Ocultar el segundo párrafo
    this.textContent = 'ver más'; // Cambiar el texto del enlace a "ver más"
  }
});